...
public class Fiction extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout homeLayout = findViewById(R.id.homefiction);
        LinearLayout myBooksLayout = findViewById(R.id.mybooksfiction);
        LinearLayout searchLayout = findViewById(R.id.searchfiction);
        LinearLayout moreLayout = findViewById(R.id.morefiction);
