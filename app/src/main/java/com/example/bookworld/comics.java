...
public class comics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout homeLayout = findViewById(R.id.homeComics);
        LinearLayout myBooksLayout = findViewById(R.id.mybooksComics);
        LinearLayout searchLayout = findViewById(R.id.searchComics);
        LinearLayout moreLayout = findViewById(R.id.moreComics);
