...
public class History extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout homeLayout = findViewById(R.id.homehistory);
        LinearLayout myBooksLayout = findViewById(R.id.mybookshistory);
        LinearLayout searchLayout = findViewById(R.id.searchhistory);
        LinearLayout moreLayout = findViewById(R.id.morehistory);
